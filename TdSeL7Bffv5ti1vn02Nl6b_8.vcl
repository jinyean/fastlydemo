...
pragma optional_param client_challenge_enabled true;
pragma optional_param default_ssl_check_cert 1;
pragma optional_param max_backends 20;
pragma optional_param customer_id "46xIxzrdwcRb1DaVHujKE9";
C!
W!
# Backends
...
backend F_Host_1 {
    ...
    .host = "68.65.123.71";
    .host_header = "jinyean.store";
    .max_connections = 200;
    .port = "443";
    .share_key = "TdSeL7Bffv5ti1vn02Nl6b";

    .ssl = true;
    .ssl_cert_hostname = "jinyean.store";
    .ssl_check_cert = always;
    .ssl_sni_hostname = "jinyean.store";

    .probe = {
        .expected_response = 200;
        .initial = 1;
        .interval = 60s;
        .request = "HEAD /healthcheck HTTP/1.1" "Host: jinyean.store" "Connection: close" "User-Agent: Varnish/fastly (healthcheck)";
        .threshold = 1;
        .timeout = 5s;
        .window = 2;
      }
...
# Snippet AU_Only : 10
if (client.geo.country_code != "AU") {
  error 403 "Blocked region";
}
# Snippet AU_Only end
...
# Snippet Disable_Browser_Cache : 10
  if (req.url ~ "\.jpg$") {
...
# Snippet Disable_Browser_Cache end
